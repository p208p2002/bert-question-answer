...
if __name__ == "__main__":    
    ...
    token_embeddings_list, segment_embeddings_lsit, attention_embeddings_list, raw_input_token \
        = convert_single_data_to_feature(context,question,tokenizer,doc_strike=128)
