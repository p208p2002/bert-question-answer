from core import use_model,convert_data_to_feature
import os
import logging
...
if __name__ == "__main__":
    ...
    token_embeddings_list, segment_embeddings_lsit, attention_embeddings_list = convert_data_to_feature(context,question,tokenizer)
